...
La lista de objetos impresos en 3D, electrónica y tornillería varia la he dejado en el documento ![BOM.md](https://github.com/agomezgar/masaylo/BOM.md) que tenéis en la raíz del repositorio
